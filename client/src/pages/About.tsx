...
const About : React.FC = () => {
    ...
    return (
                ...
                <Box>
                    <Text {...styles.title} ><Text as="span" variant="gradient" >Who</Text> Am I?</Text>
                    <Text {...styles.body}>I'm a second year student at the University of Waterloo studying Nanotechnology Engineering. 
                    ...
                    <Text {...styles.title}>How Do I <Text as="span" variant="gradient" >Spend My Time</Text>?</Text>
                    <Text {...styles.body}>
