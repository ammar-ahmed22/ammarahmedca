    ...
    if ((type === "heading_1" || type === "heading_2" || type === "heading_3") && TextOrImageIsText(content[0])){
            ...
            <Text key={createKey(idx)} {...styles.p}>
                {
                    content.map( (text, textIdx) => {
                        ...
                        return (
                            <Text as="span" color="red">ERROR: text at PostBlock:{idx}</Text>
                        )
                    })
                }
            </Text>
        ...
        return (
            <Flex key={createKey(idx)} {...styles.imageBox}>
                ...
                <Modal isOpen={isOpen} onClose={onClose} isCentered autoFocus={false} returnFocusOnClose={false} trapFocus={false} scrollBehavior="outside" >
