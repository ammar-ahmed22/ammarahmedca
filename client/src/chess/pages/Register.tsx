...
const Register: React.FC = () => {
  ...
  const [data, setData] = useState<
    Omit<RegisterData, "company" | "position" | "foundBy" | "profilePic">
  >({
    email: "",
    password: "",
    firstName: "",
  ...
  const [register, { submitted, error, loading }] =
    useAuthMutation<RegisterInput>("register", registerMutation);
          ...
          <>
            ...
            >
              {({
                ...
                Omit<
                  RegisterData,
                  "company" | "position" | "foundBy" | "profilePic"
              ...
              >) => (
                <form onSubmit={handleSubmit}>
                  <VStack spacing={4} align="flex-start">
                    ...
                    <Button width="full" type="submit" variant="gradient">
                      Next
                    </Button>
        ...
        {next && (
          <>
            ...
            <Text align="center" mb="4">
              Feel free to leave the fields empty if you don't want to share.
            </Text>
            <Formik
              initialValues={{
                company: "",
