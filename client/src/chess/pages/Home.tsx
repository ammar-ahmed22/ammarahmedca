...
const Home : React.FC = () => {
  ...
  return (
    <Box >
      <Text {...styles.title} variant="gradient">Chess</Text>
      <Text {...styles.subtitle}><Text variant="gradient" as="span">What</Text> is this?</Text>
      <Text {...styles.body}>
        To my fuel my coding addiction, this is the latest project that I have embarked on. Simply put, this is a 
        no time-limit chess game playable against me. The chess game in it's entirety was coded by me as a learning exercise including
        all the game logic and rendering. The user authentication system and backend was also all done on my own for learning purposes.
        To read more about the nerdy stuff, check out the GitHub README or my blog post on it all. 
      </Text>
      <HStack w="100%">
        <Box>
          <Text {...styles.subtitle}><Text variant="gradient" as="span">How</Text> does it work?</Text>
        ...
        <VStack align="center" flex="1" justify="flex-start" h="100%">
          <Box mb="2" >
            <Icon as={FaChessBoard} h="20vh" w="20vh" bgGradient="linear(to-tr, brand.purple.500, brand.blue.500)" />
          </Box>
