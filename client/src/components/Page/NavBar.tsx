...
const NavBar : React.FC<NavBarProps> = ({ active }) => {
  ...
  return (
    ...
    <Flex as="header" {...styles.main} bg={useColorModeValue("rgba(255, 255, 255, 0.8)", "rgba(26, 32, 44, 0.8)")} >
      ...
      <Flex align="center">
        ...
        <Link {...styles.navButton} _hover={{ bg: useColorModeValue("gray.50", "gray.700")}} color={ active === "home" ? primary : regular} as={ReactLink} to="/"><FontAwesomeIcon icon={faHome as IconProp}/><Text>Home</Text></Link>
