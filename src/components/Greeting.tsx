...
const Greeting : React.FC<GreetingProps> = ({captions, greetings, emojis, animations}) => {

  if (captions.length !== greetings.length || emojis.length !== greetings.length || animations.length !== greetings.length){
  ...
  return (
    <VStack align="flex-end">
      <HStack>
        ...
        <Funmoji key={emoji} emoji={emoji} animationName={animation} fontSize={{ base: "5xl", lg: "7xl" }} />
      </HStack>
      <Text
