...
const RecursiveListItem: React.FC<RecursiveListItemProps> = ({ data, listType }) => {
  return (
    <ListItem>
      <RichText data={data.content} />
      {
        data.children && !!data.children.length && listType === "numbered_list" && (
          <OrderedList>
            {
      ...
      {
        data.children && !!data.children.length && listType === "bulleted_list" && (
          <UnorderedList>
            {
              data.children.map( child => {
                return <RecursiveListItem data={child} listType={listType} />
