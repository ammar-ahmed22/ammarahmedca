...
import { SunIcon, MoonIcon, Bars3Icon } from "@heroicons/react/16/solid"
                          ...
                          <DropdownItem
                            ...
                            classNames={{
                              base: [
                                ...
                                !isActive && "data-[hover=true]:text-foreground",
                                !isActive && "data-[hover=true]:bg-default-100",
                                !isActive && "dark:data-[hover=true]:bg-default-50",
                                "data-[selectable=true]:focus:bg-default-50",
                                "data-[pressed=true]:opacity-70",
                                "data-[focus-visible=true]:ring-default-500",
                              ],
